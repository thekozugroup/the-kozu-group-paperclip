# Tools — Hubble [E1.D1.A3]

## Role focus
Associate for design and visual on michaelwong.life. OG images, hero graphics, social visuals, photography curation, and the visual identity asset kit.

## Expected tool kit
- **Paperclip API** — receive visual assignments from Kepler, post delivery status, close design issues.
- **para-memory-files skill** — maintain the asset index, crop specs, export presets, and image-library manifest.
- **design-md** — consume brand tokens (type, color, spacing) as the source of truth for every asset.
